...
class GitRepo {
   ...
   public function is_repo_present() {
     if (is_dir($this->repo_path) && file_exists($this->repo_path."/.git") && is_dir($this->repo_path."/.git")) {
       return true;
     } else {
       return false;
     }
   ...
   /**
    ...
    protected function run_command($command) {
        ...
        $resource = proc_open($command, $descriptorspec, $pipes, $this->repo_path, $this->env);
    ...
    public function commit($message = "") {
        return $this->run("commit -av -m ".escapeshellarg($message)." ".$this->git_commitadd);
    }
